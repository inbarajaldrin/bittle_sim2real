...
# Pre-defined configs
##
from isaaclab_assets.robots.bittle import BITTLE_CFG  # isort: skip


@configclass
class BittleRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        # rewards
        self.rewards.feet_air_time.params["sensor_cfg"].body_names = "(right_front_knee_link|right_back_knee_link|left_front_knee_link|left_back_knee_link)"
        self.rewards.feet_air_time.weight = 0.01
        # self.rewards.feet_slide = RewardTermCfg(
        #     func=feet_slide,
        #     weight=-0.01,  # adjust if too strong
        #     params={"sensor_cfg": {"name": "contact_forces", "body_names": "(..._knee_link)"}},
        # )
...
@configclass
class BittleRoughEnvCfg_PLAY(BittleRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
